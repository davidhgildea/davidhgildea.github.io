...
<div style="clear: both; text-align: right;">
    <img src="/assets/Image/Esther/500/6.jpg" alt="Esther Chapter 6" class="chapter-image" style="max-width: 100%; height: auto; float: right; margin: 0 0 10px 10px; padding-left: 10%;">
    <figcaption style="font-size: 14px;">Esther Chapter 6</figcaption>
</div>
